...
const foods: PostFood[] = [
  ...
  {
    id: '410544b2-4001-4271-9855-fec4b6a6442x',
...
const workouts: PostWorkout[] = [
  {
    id: '410544b2-4001-4271-9855-fec4b6a6443z',
    user_id: '410544b2-4001-4271-9855-fec4b6a6442a',
    duration: 60,
    title: 'Run 10km',
  ...
  {
    id: '410544b2-4001-4271-9855-fec4b6a6443x',
    user_id: '410544b2-4001-4271-9855-fec4b6a6442b',
    duration: 90,
    title: 'Gym workout',
...
const rests: PostRest[] = [
  {
    id: '410544b2-4001-4271-9855-fec4b6a6449z',
    user_id: '410544b2-4001-4271-9855-fec4b6a6442a',
...
const friends: Friend[] = [
  {
    id: '410544b2-4001-4271-9855-fec4b6a6499z',
...
const foodLikes: Like[] = [
  {
    id: '410544b2-4001-4271-9855-fec4b6a6999z',
    post_id: '410544b2-4001-4271-9855-fec4b6a6442z',
    user_id: '410544b2-4001-4271-9855-fec4b6a6442b',
    created_at: new Date('2024-01-09').toISOString(),
  },
];

const workoutLikes: Like[] = [
  {
    id: '410544b2-4001-4271-9855-fec4b6a6999x',
    post_id: '410544b2-4001-4271-9855-fec4b6a6443x',
    user_id: '410544b2-4001-4271-9855-fec4b6a6442a',
    created_at: new Date('2024-01-09').toISOString(),
  },
];

const foodComments: Comment[] = [
  {
    id: '410544b2-4001-4271-9855-fec4b6a6999z',
    post_id: '410544b2-4001-4271-9855-fec4b6a6442z',
    user_id: '410544b2-4001-4271-9855-fec4b6a6442b',
