export default function InputMacros({ label, id }: { label: string, id: string }) {
	return (
		<div className="">
			...
			<div className="flex">
				<input type="number" min={0} defaultValue={0} id={id} className="peer bg-emerald-50 border border-emerald-300 text-gray-900 text rounded-l-lg focus:ring-emerald-500 block w-16 text-right p-2.5 focus:ring-2 focus:border-emerald-500 outline-none" />
