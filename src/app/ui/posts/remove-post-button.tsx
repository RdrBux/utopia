...
export default function RemovePostButton({ postId }: { postId: string }) {
	...
	return (
		<div>
			<button onClick={handleClick} aria-label="Eliminar publicación" title="Eliminar publicación" className="border rounded-lg p-2 text-gray-700 hover:text-red-600 hover:border-red-600 duration-100">
			...
			<dialog ref={dialog} className="rounded-lg">
				<div className="bg-card flex flex-col items-center gap-1 min-w-80">
					...
					<div className="flex gap-3 mt-5">
						<button onClick={() => dialog.current?.close()} className="btn-secondary w-fit">No, cancelar</button>
