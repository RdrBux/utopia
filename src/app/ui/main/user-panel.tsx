export default function UserPanel() {
	return (
		<aside className="flex flex-col gap-6 bg-card h-fit">
			...
			<div className="p-4 rounded-lg bg-emerald-100 border border-emerald-300 text-emerald-900">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Expedita quibusdam ut quod quo aperiam eaque maiores.</div>
			<div className="p-4 rounded-lg bg-emerald-100 border border-emerald-300 text-emerald-900">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Expedita quibusdam ut quod quo aperiam eaque maiores.</div>
		</aside>
	)
}