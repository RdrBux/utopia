		...
		<nav className="bg-white border-b sticky top-0 z-20">
			<div className="flex justify-between items-center container mx-auto px-2">
				...
				<div className="flex items-center gap-2 text-gray-500">
					<Link href="/search" aria-label="Buscar" className="h-10 w-10 grid place-content-center bg-gray-100 rounded-full hover:text-gray-900">
						<svg className="w-5 h-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
							<path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="m19 19-4-4m0-7A7 7 0 1 1 1 8a7 7 0 0 1 14 0Z" />
						</svg>
					</Link>

					<Link href="/notifications" aria-label="Notificaciones" className="h-10 w-10 relative grid place-content-center bg-gray-100 rounded-full hover:text-gray-900">
					...
					<Link href='/profile/me' aria-label="Mi perfil" className="h-10 w-10 rounded-full bg-gray-100">
