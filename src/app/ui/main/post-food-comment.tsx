...
export default async function PostFoodComment({ postId }: { postId: string }) {
	...
	return (
		<Link href={`/posts/food/${postId}`} className="px-5 py-2.5 font-bold flex gap-2 items-center justify-center w-full hover:bg-gray-100 duration-100 hover:text-gray-900">
