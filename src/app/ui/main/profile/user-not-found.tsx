		...
		<section className="min-h-screen">
			<div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
				<div className="mx-auto max-w-screen-sm text-center">
					...
					<p className="mb-4 text-3xl tracking-tight font-bold text-gray-900 md:text-4xl">Usuario no encontrado.</p>
					<p className="mb-4 text-lg max-w-md mx-auto font-light text-gray-600">No hemos podido encontrar a la persona que buscas. Asegúrate de que no hayan errores en el enlace.</p>
