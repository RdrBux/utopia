...
export default async function StatsFood({ paramsId, period }: { paramsId: string, period: PeriodType }) {
	...
	return (
		<div className="border border-emerald-300 bg-emerald-50 text-emerald-950 rounded-lg p-6">
			{
				foodData.length === 0 ? (
					<div className="">No hay información de comidas en el periodo seleccionado.</div>
				) :
					(
