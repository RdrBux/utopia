	...
	return (
		<div className="bg-card p-0 divide-y">
			...
			<div className="flex border-t divide-x text-gray-600">
				...
				<Link href="/posts/new?type=rest" className="px-5 py-2.5 font-bold flex gap-2 items-center justify-center w-full hover:bg-gray-100 duration-100 hover:text-gray-900">
