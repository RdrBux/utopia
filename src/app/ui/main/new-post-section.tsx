	...
	return (
		<div className="bg-card p-0 divide-y">
			<div className="flex items-center gap-3 px-6 py-3">
				...
				<button className="bg-gray-50 text-gray-400 text-left border border-gray-300 text-sm rounded-lg focus:ring-primary-500 block w-full p-2.5 focus:ring-2 focus:border-primary-500 outline-none">
					Agregar contenido...
				</button>
			</div>
