	...
	return (
		<div className="main-layout">
			<main className="flex flex-col gap-6 lg:col-start-2 bg-white py-6 rounded-lg border">
				...
				<img className="" src="https://images.unsplash.com/photo-1486218119243-13883505764c?q=80&w=1472&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="workout" />

				<div className="px-6 flex flex-col gap-6">
					<h4 className="text-xl font-bold leading-none">10k Run</h4>
					...
					<p><b>Duración:</b> 60 minutos.</p>

				</div>

				<div className="flex items-center justify-between px-6 -mb-3">
					<Link href='/posts/workout/example/likes' className="group flex gap-1 text-sm items-center font-semibold">
