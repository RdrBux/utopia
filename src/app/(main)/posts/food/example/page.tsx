			...
			<main className="flex flex-col gap-6 lg:col-start-2 bg-white py-6 rounded-lg border">
				...
				<div className="px-6 flex flex-col gap-3 divide-y -mt-6">
					...
					<div className="flex gap-1 pt-6">
						...
						<button type="submit" className="inline-flex justify-center p-2 text-primary-600 rounded-lg h-fit cursor-pointer hover:bg-primary-100 dark:text-primary-500 dark:hover:bg-gray-600">
